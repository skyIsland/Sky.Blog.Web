...
namespace Sky.Models
{
    ...
    public partial class IpInfo : Entity<IpInfo>
    {
        #region 对象操作
        static IpInfo()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化IpInfo[访问记录]数据……");
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化IpInfo[访问记录]数据！"
        //}
        ...
        public static IpInfo FindById(Int32 id)
        {
            if (id <= 0) return null;
